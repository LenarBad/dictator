...
Первый запуск долгий: качаются модель GigaAM и веса разделения говорящих, затем собирается программа. Не закрывайте Терминал. Когда всё готово, в конце будет путь `/Applications/Dictator.app`.
